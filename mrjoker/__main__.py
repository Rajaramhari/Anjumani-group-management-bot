...
HELP_STRINGS = """
**SETTINGS**
**𝐂𝐥𝐢𝐜𝐤 𝐨𝐧 𝐭𝐡𝐞 𝐛𝐮𝐭𝐭𝐨𝐧𝐬 𝐛𝐞𝐥𝐨𝐰 𝐭𝐨 𝐠𝐞𝐭 𝐝𝐨𝐜𝐮𝐦𝐞𝐧𝐭𝐚𝐭𝐢𝐨𝐧 𝐚𝐛𝐨𝐮𝐭 𝐬𝐩𝐞𝐜𝐢𝐟𝐢𝐜 𝐦𝐨𝐝𝐮𝐥𝐞𝐬**[🤖](https://super.rootgamer.workers.dev/0:/-6302840176346508503_121.jpg)"""
    ...
    if query.data == "mrjoker_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="Movie channel", url="https://t.me/anjumani_addict"
                        ),
                        InlineKeyboardButton(
                            text="Request group", url="https://t.me/joinchat/E-6DtQ6YTjAxNDI1"
                        ),
                    ],
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="𝗟𝗢𝗚'ꜱ 🤡", url="https://t.me/joinchat/E-6DtQ6YTjAxNDI1"),
                 ],
                 [
                    InlineKeyboardButton(text="𝗦𝗨𝗣𝗣𝗢𝗥𝗧 👥", url= "https://t.me/joinchat/E-6DtQ6YTjAxNDI1"),
                 ],
